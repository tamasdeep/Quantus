...
public class ObjectPoolManager : MonoBehaviour {
    ...
    public GameObject standardHorizonalBulletPrefab, sphereBulletPrefab, sparkPrefab, bloodPrefab, beam1Prefab, beam2Prefab, beam3Prefab, beam4Prefab;

    public int numStandardHorizonalBulletsToSpawn, numSphereBulletsToSpawn, numSparksToSpawn, numBloodParticleToSpawn, numTurretBulletsToSpawn, numBeam1BulletsToSpawn, numBeam2BulletsToSpawn, numBeam3BulletsToSpawn, numBeam4BulletsToSpawn;

    public static List<GameObject> standardHorizontalBulletObjectPool, sphereBulletObjectPool, sparkObjectPool, bloodObjectPool, turretBulletObjectPool, beam1Pool, beam2Pool, beam3Pool, beam4Pool;
